<template>
  <div id="onlineInquiry">
    <van-nav-bar title="在线问诊" left-text="" left-arrow @click-left="backtrack">
...
export default {
  ...
  methods: {
    ...
    detail(id) {
      ...
      this.$router.push({ path: "/doctorDetail", query: { id: id,type:this.type }});
    },
